...
export const Pages: CollectionConfig<'pages'> = {
  slug: 'pages',
  access: {
    create: tenantEnabledAccess('pages'),
    delete: tenantEnabledAccess('pages'),
    read: tenantEnabledAccess('pages', { publicAccess: authenticatedOrPublished }),
    update: tenantEnabledAccess('pages'),
  },
